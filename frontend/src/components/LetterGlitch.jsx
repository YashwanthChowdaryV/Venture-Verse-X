...
const LetterGlitch = ({
    ...
    const outerVignetteStyle = {
        ...
        height: '100%',
        pointerEvents: 'none',
        background: `radial-gradient(circle, transparent 60%, ${outerVignetteColor} 100%)`
    };
    ...
    const centerVignetteStyle = {
        ...
        height: '100%',
        pointerEvents: 'none',
        background: `radial-gradient(circle, ${centerVignetteColor} 0%, transparent 60%)`
    };
