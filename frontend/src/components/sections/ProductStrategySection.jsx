...
import { Layers, ListChecks, Map, Rocket, TrendingUp, Target, Calendar, Gauge } from 'lucide-react';
import ScoreGauge from '../ui/ScoreGauge';

const ProductStrategySection = ({ data }) => {
  if (!data) return (
        ...
        >
          ...
          >
            <span
              ...
              style={{ color: '#5C5C5C' }}
            >
              Generated by VentureVerseX Product Strategy Agent
            </span>
