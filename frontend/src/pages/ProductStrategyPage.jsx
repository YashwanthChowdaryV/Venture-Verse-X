...
import { Sparkles, Play, Layers, TrendingUp } from 'lucide-react';
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm leading-6 max-w-lg mx-auto" style={{ color: '#5C5C5C' }}>
                  The Product Strategy assessment has not been generated yet. Run the AI due diligence orchestrator to evaluate this venture's product roadmap, technical architecture, and market positioning.
                </p>
              </div>
    ...
    <div className="relative isolate -m-4 p-4 pt-8 pb-12 animate-fade-in-up sm:-m-6 sm:p-6 sm:pt-10 sm:pb-14">
      ...
      <div className="relative space-y-6">
        <ProductStrategySection
          data={report.productStrategyDetails}
