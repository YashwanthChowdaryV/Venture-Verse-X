...
import { Sparkles, Play, Shield, TrendingUp } from 'lucide-react';
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm leading-6 max-w-lg mx-auto" style={{ color: '#5C5C5C' }}>
                  The Risk assessment has not been generated yet. Run the AI due diligence orchestrator to identify potential threats, vulnerabilities, and mitigation strategies for this venture.
                </p>
              </div>
