            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm leading-6 max-w-lg mx-auto" style={{ color: '#5C5C5C' }}>
                  The Customer assessment has not been generated yet. Run the AI due diligence orchestrator to evaluate this venture's customer base, market fit, and growth potential.
                </p>
              </div>
