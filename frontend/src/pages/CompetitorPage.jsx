...
import { Sparkles, Play, Target, TrendingUp } from 'lucide-react';
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <h2 className="text-2xl font-black tracking-[-0.03em]" style={{ color: '#1E1E1E' }}>
                  Competitor Intelligence Required
                </h2>

                <p className="text-sm leading-6 max-w-lg mx-auto" style={{ color: '#5C5C5C' }}>
                  The Competitor assessment has not been generated yet. Run the AI due diligence orchestrator to evaluate this venture's market position and competitive landscape.
                </p>
              </div>
